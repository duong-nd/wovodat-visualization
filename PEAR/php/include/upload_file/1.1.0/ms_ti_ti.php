...
if ($id==NULL) {
	...
	$field_value[10]=xml_get_ele($ms_ti_ti_obj, "ORGDIGITIZE");         		
	$field_value[11]=xml_get_ele($ms_ti_ti_obj, "COMMENTS");	
	$field_value[12]=$ts_id;
	$field_value[13]=$ms_ti_ti_obj['results']['owners'][0]['id'];
	$field_value[14]=$ms_ti_ti_obj['results']['owners'][1]['id'];
	$field_value[15]=$ms_ti_ti_obj['results']['owners'][2]['id'];
	$field_value[16]=$ms_ti_ti_obj['results']['pubdate'];
