...
if ($id==NULL) {
	...
	$field_value[18]=xml_get_ele($ms_ds_ds_dit_obj, "ORGDIGITIZE");   
	$field_value[19]=xml_get_ele($ms_ds_ds_dit_obj, "COMMENTS");
	$field_value[20]=$ms_ds_ds_obj['id'];
	$field_value[21]=$ms_ds_ds_dit_obj['results']['owners'][0]['id'];
	$field_value[22]=$ms_ds_ds_dit_obj['results']['owners'][1]['id'];
	$field_value[23]=$ms_ds_ds_dit_obj['results']['owners'][2]['id'];
	$field_value[24]=$ms_ds_ds_dit_obj['results']['pubdate'];
