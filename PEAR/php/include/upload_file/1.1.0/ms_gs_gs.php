...
if ($id==NULL) {
	...
	$field_value[12]=xml_get_ele($ms_gs_gs_obj, "ORGDIGITIZE");	   
	$field_value[13]=xml_get_ele($ms_gs_gs_obj, "DESCRIPTION");
	$field_value[14]=xml_get_ele($ms_gs_gs_obj, "COMMENTS");	    
	$field_value[15]=$cn_id;
	$field_value[16]=$ms_gs_gs_obj['results']['owners'][0]['id'];
	$field_value[17]=$ms_gs_gs_obj['results']['owners'][1]['id'];
	$field_value[18]=$ms_gs_gs_obj['results']['owners'][2]['id'];
	$field_value[19]=$ms_gs_gs_obj['results']['pubdate'];
