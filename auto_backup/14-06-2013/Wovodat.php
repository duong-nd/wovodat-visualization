...
// dd_tlt
                    ...
                    if ($value && mysql_num_rows($value)) {
                        ...
                        echo "Deformation&ElectronicTilt&$code&$temp[1]&$temp[2]&Temp;";
                    }
// dd_tlv
                    ...
                    if ($value && mysql_num_rows($value)) {
                        while ($row = mysql_fetch_assoc($value)) {
                            ...
                            if(!$used_dd_edm[$newcode]) {
                                ...
                                echo "Deformation&EDM&$newcode&$temp[1]&$temp[2];";
                            }
                        }
...
// dd_gps
                    ...
                    while($row = mysql_fetch_assoc($value)) {
                        ...
                        if(!$used_dd_gps[$newcode]) {
                            echo "Deformation&GPS&$newcode&$temp[1]&$temp[2]&Lat;";
                            echo "Deformation&GPS&$newcode&$temp[1]&$temp[2]&Lon;";
                            echo "Deformation&GPS&$newcode&$temp[1]&$temp[2]&Elev;";
...
// dd_lev
                    ...
                    while($row = mysql_fetch_assoc($alue)) {
                        ...
                        echo "Deformation&Leveling&$newcode&$temp[1]&$temp[2];";
                    }
// dd_sar: no station? , how to display the data
// use volcano id instead
