...
if ($id==NULL) {
	...
	$field_value[10]=xml_get_ele($ms_dn_ds_dig_obj, "ORGDIGITIZE");  	
	$field_value[11]=xml_get_ele($ms_dn_ds_dig_obj, "COMMENTS");
	$field_value[12]=$ms_dn_ds_obj['id'];
	$field_value[13]=$ms_dn_ds_dig_obj['results']['owners'][0]['id'];
	$field_value[14]=$ms_dn_ds_dig_obj['results']['owners'][1]['id'];
	$field_value[15]=$ms_dn_ds_dig_obj['results']['owners'][2]['id'];
	$field_value[16]=$ms_dn_ds_dig_obj['results']['pubdate'];
