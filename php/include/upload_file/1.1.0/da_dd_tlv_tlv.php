...
if ($id==NULL) {
	...
	$field_name[9]="dd_tlv_ori";           
	$field_name[10]="dd_tlv_com";
	$field_name[11]="ds_id";
	$field_name[12]="di_tlt_id";
	$field_name[13]="cc_id";
	$field_name[14]="cc_id2";
	$field_name[15]="cc_id3";
	$field_name[16]="dd_tlv_pubdate";
	$field_name[17]="cc_id_load";
	$field_name[18]="dd_tlv_loaddate";
	...
	$field_value[9]=xml_get_ele($da_dd_tlv_tlv_obj, "ORGDIGITIZE");     
	$field_value[10]=xml_get_ele($da_dd_tlv_tlv_obj, "COMMENTS");
	$field_value[11]=$ds_id;
	$field_value[12]=$di_tlt_id;
	$field_value[13]=$da_dd_tlv_tlv_obj['results']['owners'][0]['id'];
	$field_value[14]=$da_dd_tlv_tlv_obj['results']['owners'][1]['id'];
	$field_value[15]=$da_dd_tlv_tlv_obj['results']['owners'][2]['id'];
	$field_value[16]=$da_dd_tlv_tlv_obj['results']['pubdate'];
