...
// sd_trm
                ...
                $value = mysql_query("select b.sd_trm_id from ss a, sd_trm b where a.ss_code = '$code' and ((b.ss_id is not null and b.ss_id=a.ss_id) or (b.ss_id is null and b.sn_id is not null and b.sn_id=a.sn_id)) limit 0,1")                ;
                if ($value && mysql_num_rows($value)) {
