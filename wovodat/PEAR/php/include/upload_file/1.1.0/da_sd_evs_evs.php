...
if ($id==NULL) {
	...
	$field_name[12]="sd_evs_eqtype";                   
	$field_name[13]="sd_evs_ori";                      
	$field_name[14]="sd_evs_com";                    
	$field_name[15]="ss_id";
	$field_name[16]="cc_id";
	$field_name[17]="cc_id2";
	$field_name[18]="cc_id3";
	$field_name[19]="sd_evs_pubdate";
	$field_name[20]="cc_id_load";
	$field_name[21]="sd_evs_loaddate";
	$field_name[22]="cb_ids";
	$field_value=array();
	$field_value[0]=$code;
	$field_value[1]=$da_sd_evs_evs_obj['results']['sd_evs_time'];
	$field_value[2]=xml_get_ele($da_sd_evs_evs_obj, "STARTTIMECSEC");      
	$field_value[3]=$da_sd_evs_evs_obj['results']['sd_evs_time_unc'];
	$field_value[4]=xml_get_ele($da_sd_evs_evs_obj, "STARTTIMECSECUNC");  	
	...
	$field_value[12]=xml_get_ele($da_sd_evs_evs_obj, "EARTHQUAKETYPE");      
	$field_value[13]=xml_get_ele($da_sd_evs_evs_obj, "ORGDIGITIZE");      	
	$field_value[14]=xml_get_ele($da_sd_evs_evs_obj, "COMMENTS");	         
	$field_value[15]=$ss_id;
	$field_value[16]=$da_sd_evs_evs_obj['results']['owners'][0]['id'];
	$field_value[17]=$da_sd_evs_evs_obj['results']['owners'][1]['id'];
	$field_value[18]=$da_sd_evs_evs_obj['results']['owners'][2]['id'];
	$field_value[19]=$da_sd_evs_evs_obj['results']['pubdate'];
