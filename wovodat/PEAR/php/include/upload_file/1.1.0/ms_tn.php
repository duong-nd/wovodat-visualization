...
if ($id==NULL) {
	...
	$field_value[4]=xml_get_ele($ms_tn_obj, "COMMONNETMAP");
	$field_value[5]=$stime;
	$field_value[6]=xml_get_ele($ms_tn_obj, "STARTTIMEUNC");
	$field_value[7]=xml_get_ele($ms_tn_obj, "ENDTIME");
	$field_value[8]=xml_get_ele($ms_tn_obj, "ENDTIMEUNC");
	$field_value[9]=xml_get_ele($ms_tn_obj, "DIFFUTC");
	$field_value[10]=xml_get_ele($ms_tn_obj, "DESCRIPTION");   
	$field_value[11]=xml_get_ele($ms_tn_obj, "ORGDIGITIZE");	  
	$field_value[12]=xml_get_ele($ms_tn_obj, "COMMENTS");
	$field_value[13]=$ms_tn_obj['results']['owners'][0]['id'];
	$field_value[14]=$ms_tn_obj['results']['owners'][1]['id'];
	$field_value[15]=$ms_tn_obj['results']['owners'][2]['id'];
	$field_value[16]=$current_time;
	$field_value[17]=$ms_tn_obj['results']['pubdate'];
...
// Else, UPDATE
	...
	$field_value[1]=xml_get_ele($ms_tn_obj, "NAME");
	$field_value[2]=xml_get_ele($ms_tn_obj, "AREA");
	$field_value[3]=xml_get_ele($ms_tn_obj, "COMMONNETMAP");	
	$field_value[4]=xml_get_ele($ms_tn_obj, "STARTTIMEUNC");
	$field_value[5]=xml_get_ele($ms_tn_obj, "ENDTIME");
	$field_value[6]=xml_get_ele($ms_tn_obj, "ENDTIMEUNC");
	$field_value[7]=xml_get_ele($ms_tn_obj, "DIFFUTC");
	$field_value[8]=xml_get_ele($ms_tn_obj, "DESCRIPTION");
	$field_value[9]=xml_get_ele($ms_tn_obj, "ORGDIGITIZE");
