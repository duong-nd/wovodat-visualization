...
if ($id==NULL) {
	...
	$field_value[14]=$ms_cs_sate_obj['results']['pubdate'];
...
// Else, UPDATE
	...
	$field_value[5]=xml_get_ele($ms_cs_sate_obj, "DESCRIPTION");
	$field_value[6]=xml_get_ele($ms_cs_sate_obj, "ORGDIGITIZE");	
	$field_value[7]=xml_get_ele($ms_cs_sate_obj, "COMMENTS");	
	$field_value[8]=$ms_cs_sate_obj['results']['owners'][0]['id'];
	$field_value[9]=$ms_cs_sate_obj['results']['owners'][1]['id'];
	$field_value[10]=$ms_cs_sate_obj['results']['owners'][2]['id'];
