...
// Get owners
$owners=$ms_fn_obj['results']['owners'];

// Get start time
$stime=xml_get_ele($ms_fn_obj, "STARTTIME");

// Get volcanoes
$vd_ids=$ms_fn_obj['results']['vd_ids'];
$vd_ids_cnt=count($vd_ids);

// INSERT or UPDATE?
$id=v1_get_id_cn_stime("fn", $code, $stime, $owners);
...
if ($id==NULL) {
	...
	$field_value=array();
	$field_value[0]=$code;
	$field_value[1]=xml_get_ele($ms_fn_obj, "NAME");           
	$field_value[2]="Fields";
	$field_value[3]=xml_get_ele($ms_fn_obj, "AREA");  
	$field_value[4]=xml_get_ele($ms_fn_obj, "COMMONNETMAP");
	$field_value[5]=$stime;
	$field_value[6]=xml_get_ele($ms_fn_obj, "STARTTIMEUNC");
	$field_value[7]=xml_get_ele($ms_fn_obj, "ENDTIME");
	$field_value[8]=xml_get_ele($ms_fn_obj, "ENDTIMEUNC");
	$field_value[9]=xml_get_ele($ms_fn_obj, "DIFFUTC");
	$field_value[10]=xml_get_ele($ms_fn_obj, "DESCRIPTION");   
	$field_value[11]=xml_get_ele($ms_fn_obj, "ORGDIGITIZE");	  
	$field_value[12]=xml_get_ele($ms_fn_obj, "COMMENTS");
	$field_value[13]=$ms_fn_obj['results']['owners'][0]['id'];
	$field_value[14]=$ms_fn_obj['results']['owners'][1]['id'];
	$field_value[15]=$ms_fn_obj['results']['owners'][2]['id'];
	$field_value[16]=$current_time;
	$field_value[17]=$ms_fn_obj['results']['pubdate'];
...
// Else, UPDATE
	...
	$field_value[1]=xml_get_ele($ms_fn_obj, "NAME");
	$field_value[2]=xml_get_ele($ms_fn_obj, "AREA");
	$field_value[3]=xml_get_ele($ms_fn_obj, "COMMONNETMAP");	
	$field_value[4]=xml_get_ele($ms_fn_obj, "STARTTIMEUNC");
	$field_value[5]=xml_get_ele($ms_fn_obj, "ENDTIME");
	$field_value[6]=xml_get_ele($ms_fn_obj, "ENDTIMEUNC");
	$field_value[7]=xml_get_ele($ms_fn_obj, "DIFFUTC");
	$field_value[8]=xml_get_ele($ms_fn_obj, "DESCRIPTION");
	$field_value[9]=xml_get_ele($ms_fn_obj, "ORGDIGITIZE");
	$field_value[10]=xml_get_ele($ms_fn_obj, "COMMENTS");
	$field_value[11]=$ms_fn_obj['results']['owners'][0]['id'];
	$field_value[12]=$ms_fn_obj['results']['owners'][1]['id'];
	$field_value[13]=$ms_fn_obj['results']['owners'][2]['id'];
	$field_value[14]=$ms_fn_obj['results']['pubdate'];
